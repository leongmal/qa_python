...
class TestBooksCollector:
    ...
    def test_get_book_genre_valid(self, collector, add_book_new):
    ...
    def test_get_books_for_children_valid(self, collector, add_book_new):
        add_book_new('Незнайка', 'Мультфильмы')
        add_book_new('Буратино', 'Комедии')
        add_book_new('Челюсти', 'Ужасы')
